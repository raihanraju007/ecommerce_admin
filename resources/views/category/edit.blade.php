                ...
                <div class="card-body">
                    ...
                    <form action="{{route('update-category')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="description" id="horizontal-email-input2">{{$category->description}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img src="{{asset($category->image)}}" alt="" height="60" width="100"/>
                            </div>
                        </div>
