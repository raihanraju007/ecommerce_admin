    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Update Sub Category Module</h4>
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('sub-category.update', $subCategory->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="{{$subCategory->name}}" name="name" class="form-control" id="horizontal-firstname-input">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="description" id="horizontal-email-input2">{{$subCategory->description}}</textarea>
                                ...
                                <td>
                                    ...
                                    @else
                                        <a href="{{route('sub-category.show', $sub_category->id)}}" class="btn btn-warning btn-sm btn-rounded">
                                            ...
                                            <a href="{{route('sub-category.destroy', $sub_category->id)}}" class="btn btn-danger btn-sm btn-rounded" onclick="return confirm('Are You sure to Delete this'); ">
